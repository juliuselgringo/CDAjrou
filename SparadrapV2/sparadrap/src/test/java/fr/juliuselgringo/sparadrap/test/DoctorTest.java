...
class DoctorTest {
    ...
    public void setDoctorCustomersList_InvalidInput() throws InputException {
        ...
        assertThrows(InputException.class, (Executable) () -> {testDoctor.setDoctorCustomersList(customerTest);});
    }
    ...
    public void setDoctorPrescriptionsList_ValidInput() throws InputException {
        ...
        InputException thrown = assertThrows(InputException.class, (Executable) () -> {
